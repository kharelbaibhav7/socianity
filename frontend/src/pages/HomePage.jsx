...
const HomePage = () => {
    ...
    return (
        <div className="px-8 min-h-screen relative bg-[#c7cce5] text-gray-800">
            ...
            {/* About Section */}
            <div className="flex justify-evenly flex-col md:flex-row items-center bg-white p-8 rounded-3xl shadow-xl mt-12 max-w-6xl mx-auto">
                <div className="md:w-1/2">
                    <h3 className="text-4xl font-bold mt-2 text-blue-500">About Socianity</h3>
            ...
            <div className="text-center mt-12 px-8">
                ...
                <motion.button whileHover={{ scale: 1.1 }} className="mt-6 px-8 py-3 bg-blue-500 text-white rounded-2xl shadow-lg hover:bg-purple-600 font-comic-neue" onClick={redirectHome}>
                    Join Now
                </motion.button>
            </div>
